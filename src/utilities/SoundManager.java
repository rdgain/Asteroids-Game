...
public class SoundManager {
    ...
    public final static Clip[] saucerBullets = new Clip[15];
 ...
 static {
        for (int i = 0; i < saucerBullets.length; i++)
            saucerBullets[i] = getClip("saucerBig");
    }
    ...
    public static void saucerFire() {
        // fire the n-th bullet and increment the index
        Clip clip = saucerBullets[nSBullet];
        clip.setFramePosition(0);
        clip.start();
        nSBullet = (nSBullet + 1) % saucerBullets.length;
    }
